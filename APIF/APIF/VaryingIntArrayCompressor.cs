...
namespace APIF
{
    class VaryingIntArrayCompressor
    {
        ...
        public static BitStreamFIFO Compress(int[] source)
        {
            ...
            compressionInfo.Write(lengthSaveLength, 2);                 //The amount of bits needed to save the total length in bits of the compressed data
        ...
        public static int[] Decompress(ref BitStreamFIFO source)
        {
            ...
            int lengthSaveLength = source.ReadInt(2) * 8;           //The amount of bits needed to save the total length in bits of the compressed data
